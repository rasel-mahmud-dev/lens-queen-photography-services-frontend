...
const MyWorkSection = () => {
	...
	return (
		<section className="section">
				...
				{projects &&
					projects.map((project) => (
						<div className="my-project-img-root my-4" key={project._id}>
							...
							<h4 className="text-center font-medium text-sm text-dark-300 my-2">{project.type}</h4>
						</div>
					))}
			</div>
			...
			{!projects && (
				<div>
					<Loader title="Project are fetching" className="flex justify-center my-10" />
				</div>
			)}
			...
			<div className="flex justify-center flex-col md:flex-row gap-10 max-w-4xl mx-auto  border-t pt-10 mt-12">
				...
				<div className="text-center">
					...
					<p className="para">In my passed 3 years services almost 347+ peoples are satisfied</p>
				</div>
			</div>
		</section>
	);
