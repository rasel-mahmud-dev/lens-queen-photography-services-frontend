	...
	return (
		<>
			<footer className="bg-primary-800 pb-10 py-14">
				<div
					className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center gap-6">
					<div className="">
						<h3 className="font-semibold text-gray-50">About Me</h3>
						<p className="text-dark-5 mt-2 text-sm">
							Hi, I’m Rani Queen, a professional photographer, traveler & blogger. I help peoples capture their valuable
							memories that never get back at any costs.
						</p>
					...
					<div className="mt-4 lg:mt-0">
						...
						<ul className="mt-2 text-dark-5 text-sm">
							<li className="">
								<Link to="/blogs" className="hover:text-primary-500">
									Blogs
								</Link>
							</li>
							<li className="pt-1">
			...
			<footer className="bg-primary-800/90 py-4">
				<div
					className="container flex flex-col md:flex-row text-center md:text-start gap-4 md:gap-4 justify-between text-white">
					<h1>Copyright © {new Date().getFullYear()} LensQueen</h1>
